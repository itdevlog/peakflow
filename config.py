...
# Пороги зон
# ============================================================================
# ZONE_RED документирует "опасную" границу (50%); фактическая красная зона в
# логике начинается ниже ZONE_YELLOW (60%) — см. report.pef_zone. Не путать.
ZONE_GREEN = 80   # ≥ 80% — хорошая компенсация
ZONE_YELLOW = 60  # 60–79% — внимание
ZONE_RED = 50     # справочный порог "опасно" (< 60% фактически)
