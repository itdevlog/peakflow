...
# Пороги зон
# ============================================================================
# Красная зона начинается ниже ZONE_YELLOW (60%) — см. report.pef_zone.
ZONE_GREEN = 80   # ≥ 80% — хорошая компенсация
ZONE_YELLOW = 60  # 60–79% — внимание

# ============================================================================
# Время напоминаний (по умолчанию; настраивается в БД, см.
# database.REMINDER_HOURS_DEFAULT / get_reminder_hours)
# ============================================================================
